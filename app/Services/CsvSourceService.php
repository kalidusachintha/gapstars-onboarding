...
class CsvSourceService implements Onboarding
{
     ...
     *
     */
    public function getOnboardStepsPrecentage() : \Illuminate\Http\JsonResponse
    {
        ...
        $results_onboard = $this->getWeeklyOnboardData($source_data);
    ...
    /**
     * calculate onboarding percentage for each step weekly
